...
DEFAULT_API_INTEGRATIONS = [
    ...
    },
    {
        ...
        "auth_type": "API_KEY",
        "api_key": "a5ef1003ecfa0c54be51bb797fee6b00",
        "client_id": "",
        "client_secret": "",
        "merchant_id": "001020345",
        "api_version": "100",
        "currency": "XAF",
        "operation": "PURCHASE",
...
def normalize_integration(item: dict):
    ...
    return {
        ...
        # AFB_MASTERCARD_GATEWAY_FIELDS_V1 : champs lus par le service de
        # paiement — sans eux, une sauvegarde admin les effaçait du JSON.
